      ...
      <section className="relative bg-gradient-to-br from-primary-50 to-secondary-50 py-20 lg:py-32">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            ...
            {/* Updated CTAs based on auth state and correct routes */}
      ...
      <section className="bg-gray-50 py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="heading-lg mb-4">Join the Movement</h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Thousands of style storytellers are already celebrating authentic fashion
            </p>
          </div>
          
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="text-3xl font-bold text-primary-600 mb-2">12K+</div>
              <div className="text-gray-600">Style Stories Shared</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-primary-600 mb-2">3K+</div>
          ...
          {user ? (
            <>
              <h2 className="heading-lg text-white mb-4">
                Ready to share your next style story?
              </h2>
              <p className="text-primary-100 text-lg mb-8 max-w-2xl mx-auto">
                Your wardrobe has stories to tell - let&apos;s document them together
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/upload">
                  <Button variant="outline" size="lg" className="bg-white text-primary-600 hover:bg-gray-50 w-full sm:w-auto">
                    Upload Your Story
                  </Button>
                </Link>
                <Link href="/feed">
